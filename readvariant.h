...
typedef struct 
{
	...
	short type,length; char simple; // '1' for simple indels, '0' for complex indels 
	...
	int depth; int A1,A2; int H1,H2; // total reads covering this variant (haploid/diploid, A1-> reads supporting reference allele (single-read)
	int rightshift; // indel position to the right
